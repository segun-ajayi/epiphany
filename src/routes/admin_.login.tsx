...
export const Route = createFileRoute("/admin_/login")({
  head: () => ({
    meta: [{ title: "Admin Login — Epiphany" }, { name: "robots", content: "noindex" }],
  }),
...
function AdminLoginPage() {
  ...
  return (
    <div className="min-h-[80vh] grid place-items-center px-4 py-12">
      <form
        onSubmit={onSubmit}
        className="w-full max-w-sm rounded-3xl border border-border bg-card p-8 shadow-elegant space-y-5"
      >
