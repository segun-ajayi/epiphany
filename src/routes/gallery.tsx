    ...
    <>
      ...
      {current && (
        ...
        >
          ...
          <figure onClick={(e) => e.stopPropagation()} className="max-h-[90vh] max-w-[90vw] flex flex-col items-center gap-3">
            <img src={current.src} alt={current.alt} className="max-h-[80vh] max-w-[90vw] object-contain rounded-xl" />
