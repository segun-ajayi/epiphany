    ...
    >
      <div className="container-page flex h-16 items-center justify-between gap-4 md:h-20">
        <Link to="/" className="flex items-center gap-3 group" aria-label={CHURCH.name}>
          <span className="relative grid place-items-center size-10 rounded-full bg-primary text-primary-foreground shadow-elegant">
            <span className="font-display text-lg">✦</span>
            <span className="absolute inset-0 rounded-full ring-1 ring-gold/60" aria-hidden />
          </span>
          <span className="hidden sm:flex flex-col leading-tight">
            <span className="font-display text-base md:text-lg text-foreground">Epiphany</span>
            <span className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Anglican · Houston</span>
          </span>
        </Link>
